...
Graph 1
This graph displays the data of ISU and UofIowa students that completed school in 4 years. The y-axis displays the count of students and the x-axis displays the year. The top 2 lines of the plot show the total count of both female and male students for both universities. The bottom 4 lines show the count of both genders separately along with indicated color of the university which can be seen on the legend that is on the right side of the plot. The plot itself was designed to compare the number of students that completed their education in 4 years from both universities.
...
geom_line(aes(y=median_debt.pell_grant.y,group=1,color="UI",linetype="Pell"))+
  ylab("Debt Value") + xlab("Year") + ggtitle("Debt of students with or without Pell Grant") + theme(text = element_text(size=12))
```
